...
from .test_consumers import TestNegotiationWindowConsumer, TermsSheetConsumer, TestNotificationConsumer
...
websocket_urlpatterns = [
    ...
    path("api/notifications/<int:user_id>/", TestNotificationConsumer.as_asgi()),
]
